...
void CANFD_Open(CANFD_T *psCanfd, CANFD_FD_T *psCanfdStr)
{
    ...
    if (psCanfd == (CANFD_T *)CANFD0)
    {
        ...
        else if ((CLK->CLKSEL0 & CLK_CLKSEL0_CANFD0SEL_Msk) == CLK_CLKSEL0_CANFD0SEL_PLL_DIV2)
        {
            u32CanFdClock = CLK_GetPLLClockFreq() / 2;
        }
    ...
    else if (psCanfd == (CANFD_T *)CANFD1)
    {
        ...
        else if ((CLK->CLKSEL0 & CLK_CLKSEL0_CANFD1SEL_Msk) == CLK_CLKSEL0_CANFD1SEL_PLL_DIV2)
        {
            u32CanFdClock = CLK_GetPLLClockFreq() / 2;
        }
    ...
    else if (psCanfd == (CANFD_T *)CANFD2)
    {
        ...
        if ((CLK->CLKSEL0 & CLK_CLKSEL0_CANFD2SEL_Msk) == CLK_CLKSEL0_CANFD2SEL_HXT)
        {
            u32CanFdClock = CLK_GetHXTFreq();
        }
        else if ((CLK->CLKSEL0 & CLK_CLKSEL0_CANFD2SEL_Msk) == CLK_CLKSEL0_CANFD2SEL_PLL_DIV2)
        {
            u32CanFdClock = CLK_GetPLLClockFreq() / 2;
        }
        else if ((CLK->CLKSEL0 & CLK_CLKSEL0_CANFD2SEL_Msk) == CLK_CLKSEL0_CANFD2SEL_HCLK)
        {
            u32CanFdClock = CLK_GetHCLKFreq();
        }
        else if ((CLK->CLKSEL0 & CLK_CLKSEL0_CANFD2SEL_Msk) == CLK_CLKSEL0_CANFD2SEL_HIRC)
        {
            u32CanFdClock = __HIRC;
        }
