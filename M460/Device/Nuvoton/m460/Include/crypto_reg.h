...
typedef struct
{
     ...
     * |        |          |PRNG seed must from TRNG and key is must written to the SRAM of key store (WSDST, CRYPTO_PRNG_KSCTL[23:22] must set to u201800u2019)
...
#define CRYPTO_RSA_CTL_KEYLEN_Pos          (4)                                                /*!< CRYPTO_T::RSA_CTL: KEYLEN Position      */
#define CRYPTO_RSA_CTL_KEYLEN_Msk          (0x3ul << CRYPTO_RSA_CTL_KEYLEN_Pos)                /*!< CRYPTO_T::RSA_CTL: KEYLEN Mask          */

#define CRYPTO_RSA_CTL_SCAP_Pos             (8)                                               /*!< CRYPTO RSA_CTL: SCAP Position             */
#define CRYPTO_RSA_CTL_SCAP_Msk             (0x1ul << CRYPTO_RSA_CTL_SCAP_Pos)                  /*!< CRYPTO RSA_CTL: SCAP Mask                 */
