               ...
               uint32_t u32IDOS)
{
    ...
    if ((llsi == LLSI0) || (llsi == LLSI2) || (llsi == LLSI4) || (llsi == LLSI6) || (llsi == LLSI8) ||
            (llsi == LLSI0_NS) || (llsi == LLSI2_NS) || (llsi == LLSI4_NS) || (llsi == LLSI6_NS) || (llsi == LLSI8_NS) ||
            (llsi == (LLSI_T *)ELLSI0) || (llsi == (LLSI_T *)ELLSI0_NS))
        u32PCLKFreq = CLK_GetPCLK0Freq();
    else if ((llsi == LLSI1) || (llsi == LLSI3) || (llsi == LLSI5) || (llsi == LLSI7) || (llsi == LLSI9) ||
             (llsi == LLSI1_NS) || (llsi == LLSI3_NS) || (llsi == LLSI5_NS) || (llsi == LLSI7_NS) || (llsi == LLSI9_NS))
